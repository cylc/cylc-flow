...
class startup(oneoff, free):
    # AUTO-GENERATED FROM /home/oliverh/cylc/master/suites/ensemble/taskdef/startup.def
    ...
    description = []
    description.append("Oneoff startup task for the cylc userguide example system: it cleans")
    description.append("out the system working directory.")
