...
from cylc.flow.network.graphql import (
    CylcVisitor, null_setter, null_stripper, async_next, NULL_VALUE, grow_tree
)
...
async def test_null_stripper(pre_result, expected_result):
    """Test the null stripping of different result data/types."""
    # non-async
    post_result = async_next(null_stripper, pre_result)
    assert post_result == expected_result
    ...
    # async
    async_post_result = async_next(null_stripper, async_result(pre_result))
