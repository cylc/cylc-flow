...
def test_get_satisfied_dependencies(prereq2: Prerequisite):
    assert prereq2.get_satisfied_dependencies() == [
        '1/a',
        '1/c',
        '1/d',
    ]
...
def test_naturally_satisfied_dependencies(prereq2: Prerequisite):
    assert prereq2.naturally_satisfied_dependencies() == [
        ('1', 'a', 'x'),
        ('1', 'c', 'x'),
    ]
