...
run_fail "${TEST_NAME_BASE}-simple-1" cylc validate "${PWD}/flow.cylc"
...
run_fail "${TEST_NAME_BASE}-simple-2" cylc validate "${PWD}/flow.cylc"
...
run_fail "${TEST_NAME_BASE}-simple-fam" cylc validate "${PWD}/flow.cylc"
...
run_fail "${TEST_NAME_BASE}-intercycle-1" cylc validate "${PWD}/flow.cylc"
...
run_fail "${TEST_NAME_BASE}-intercycle-2" cylc validate "${PWD}/flow.cylc"
...
run_fail "${TEST_NAME_BASE}-param-1" cylc validate "${PWD}/flow.cylc"
...
run_ok "${TEST_NAME_BASE}-param-2" cylc validate "${PWD}/flow.cylc"
