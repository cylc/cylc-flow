...
poll_grep_workflow_log -E 't1\.19700101T0000Z submitted .* => running'
poll_grep_workflow_log -E 't1\.19700101T0000Z running .* => failed'
...
run_ok "${TEST_NAME_BASE}-trigger" \
    cylc trigger "${WORKFLOW_NAME}" 't1.19700101T0000Z'
