...
MUST BE RUN IN SAME PYTHONPATH ENVIRONMENT AS CYCLON SO
WE ACCESS THE SAME CYCLON CONFIG FILE
(so restart this if you restart cyclon in different mode)
...
title = kit( "cyclon system monitor" )
