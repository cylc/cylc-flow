...
'''
        outfile = os.path.join( dir, self.classfile_name )
        ...
        OUT.write( self.indent + '# AUTO-GENERATED FROM BY CYLC\n\n' )  
        ...
        if inherit:
            OUT.write( indent + 'super(' + self.name + ', self ).__init__(' + task_inherit_super_args + ' )\n\n' )
