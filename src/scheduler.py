 ...
 *  $ dot -Teps foo.dot -o foo.eps # eps output"
 *  $ dot -Tsvg foo.dot -o foo.svg # svg output"
 * To get a more pleasing result you may want to edit this file and/or use
 * other graphviz commands. See graphviz documentation; in particular
 * the userguide "Drawing graphs with dot".
 */\n\n''' )
            ...
            self.graphfile.write( '    node [ style=filled, fillcolor=skyblue, color=midnightblue ];\n' )
            self.graphfile.write( '    edge [ color=midnightblue ];\n' )
        else:
            self.graphfile = None
