...
###                    self.member_of[ name ] = memof
    ...
    def configure_suite( self ):
        ...
        globalenv['CYLC_DUMMY_SLEEP'] =  self.config['dummy mode']['dummy task run length in seconds']
