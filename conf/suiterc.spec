...
[runtime]
    [[root]]
        ...
        command scripting = string( default='echo Default command scripting; sleep 10')
        dummy mode command scripting = string( default='echo Dummy command scripting; sleep 10')
        simulation mode run length = float( default=10 )
        fail in simulation mode = boolean( default=False )
    ...
    [[__many__]]
        ...
        dummy mode command scripting = string( default=None )
