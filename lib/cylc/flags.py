...
class SyntaxVersionError(ValueError):
    ...
    ERROR_CONFLICTING_SYNTAX_VERSIONS = "Cannot mix prev and new syntax: %s"

    def __str__(self):
        return self.ERROR_CONFLICTING_SYNTAX_VERSIONS % self.args[0]
