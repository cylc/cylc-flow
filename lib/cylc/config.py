...
class config( CylcConfigObj ):
    def __init__( self, suite=None, simulation_mode=False, path=None ):
        ...
        self.cylc_suite_owner, self.cylc_suite_group, self.cylc_suite_name = regsplit( self.suite ).get()
    ...
    def process_directories(self):
        ...
        os.environ['CYLC_SUITE_GROUP' ] = self.cylc_suite_group
        os.environ['CYLC_SUITE_NAME'  ] = self.cylc_suite_name
        ...
        for item in self['runtime']:
            ...
            if self['runtime'][item]['remote']['log directory']:
                for var in ['CYLC_SUITE', 'CYLC_SUITE_GROUP', 'CYLC_SUITE_NAME', 'CYLC_SUITE_DIR']: 
