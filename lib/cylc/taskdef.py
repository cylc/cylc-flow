...
class taskdef(object):
    ...
    def get_task_class( self ):
        ...
        # class init function
        def tclass_init( sself, start_tag, initial_state, stop_c_time=None, startup=False, validate=False, submit_num=0, is_firsttime=True ):
            ...
            sself.is_firsttime=is_firsttime
