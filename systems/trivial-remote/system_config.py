...
#  /home/oliverh/cylc/systems/trivial-remote
...
class system_config( config ):
    ...
    def __init__( self, sysname ):
        ...
        # can multiple instances of this system run at once?
        ...
        # Default job submit method for the system. Available methods
        ...
        # registered system name via the Python variable 'sysname':

        self.items['environment']['REMOTE_HOST'] = 'localhost'
