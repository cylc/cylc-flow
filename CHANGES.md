...
[#3471](https://github.com/cylc/cylc-flow/pull/3471) - allow the `wall_clock`
xtrigger to use an alternate timezone when checking if it is time to run. This
only works when the suite is running with UTC cycle points.
