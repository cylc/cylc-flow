...
-------------------------------------------------------------------------------
## __cylc-7.9.1 (2020-04-22)__

(Note this release branches off 7.8.6, as 7.9.0 branches off 7.8.5)

**Requires Python 2.7**

This release is the same as cylc-7.8.6 with Jinja2 upgraded to 2.11.1.
