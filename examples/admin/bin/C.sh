...
touch $RUNNING_DIR/C-$(cylc cycletime --offset-hours=6 ).restart
touch $RUNNING_DIR/C-$(cylc cycletime --offset-hours=12).restart
touch $RUNNING_DIR/C-$(cylc cycletime --offset-hours=18).restart
