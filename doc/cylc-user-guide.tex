...
\begin{figure}
    ...
    \end{center}
\caption[The examples:CUG\_QS1 dependency graph]{\small The examples:CUG\_QS1 dependency graph.}
...
\begin{figure}
    ...
    \end{center}
    \caption[Suite examples:CUG\_QS1 at startup, 06 or 18 hours.]
    \caption{\small Suite examples:CUG\_QS1 at startup with an initial
...
\begin{figure}
    ...
    \end{center}
    \caption[Suite examples:CUG\_QS1 at startup, 00 or 12 hours]{\small
    Suite examples:CUG\_QS1 at startup with an initial cycle time ending
    in 00 or 12 hours.} \label{fig-QuickStartA-ControlStart00}
\end{figure} 
...
and observe what happens: all the GetData tasks out to a few cycles
ahead
...
\begin{figure}
    ...
    \end{center}
    \caption[Suite examples:CUG\_QS1 running, showing multiple
    clock-triggered GetData tasks running at once.]
    {\small Suite examples:CUG\_QS1 running, showing multiple
...
\begin{figure}
    ...
    \end{center}
    \caption[ Suite examples:CUG\_QS1 stalled after 
    the clock-triggered GetData tasks have finished.]
{\small Suite examples:CUG\_QS1 stalled after the clock-triggered
GetData tasks have finished, because of Model's
...
\begin{figure}
    ...
    \end{center}
\caption[The examples:CUG\_QS2 graph with model cold start task.]{\small
The examples:CUG\_QS2 dependency graph showing a model cold start task.}
...
\begin{figure}
    ...
    \end{center}
\caption[Suite CUG73 Validation.]{\small Suite CUG73 Validation.}
...
If you use \lstinline=set -e=, any explicit error checking
must be done inline to avoid triggering the trap:
...
In this section we explain how tasks are executed once they are ready to
run (i.e.\ once their prerequisites are satisfied), and how to create new 
...
Some of the following topics are yet to be properly documented. For
the moment, see cylc command line help (included here in
...
\begin{myitemize}
    ...
    \item getting information from suites and tasks 
        {\em (\lstinline=cylc info help=, \lstinline=cylc discovery help=)}
