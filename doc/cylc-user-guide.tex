...
cylc access automatically. Note that the variable \lstinline=$CYLC_DIR=
is required inside the environment script, so don't skip the export
step.  You should now be able to use cylc:
\begin{lstlisting}
$ cylc --version
3.0.0
\end{lstlisting}
...
$ cylc db print --central
 ...
 admin:examples:CUG73  "Cylc User Guide Dependency Graph Example"  /home/admin/cylc/examples/CUG7.3
 admin:examples:CUG74  "A two-task test suite"  /home/admin/cylc/examples/CUG7.4
 admin:examples:CUG_QS1  "Cylc User Guide Quick Start Example 1"  /home/admin/cylc/examples/CUG5/one
 admin:examples:CUG_QS2  "Cylc User Guide Quick Start Example 2"  /home/admin/cylc/examples/CUG5/two
 admin:examples:CUG_QS3  "Cylc User Guide Quick Start Example 3"  /home/admin/cylc/examples/CUG5/three
 admin:examples:FFHook  "family failure hook script example"  /home/admin/cylc/examples/AutoCleanup/FamilyFailHook
 admin:examples:FFTask  "family failure cleanup task example"  /home/admin/cylc/examples/AutoCleanup/FamilyFailTask
DONE
\end{lstlisting}
