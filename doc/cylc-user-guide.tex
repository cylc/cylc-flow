...
[tasks]
    [[GetData]]
        command = cylc wrap -m "set -e; echo DUMMY $TASK_ID; sleep $CYLC_SIMULATION_SLEEP"
\end{lstlisting}
...
[tasks]
    [[suicidal]]
        ...
        command = cylc wrap -m "set -e; sleep 30; echo Goodbye cruel world; /bin/false"
\end{lstlisting}

You can test this on the command line:
\begin{lstlisting}
$ cylc wrap -m "set -e; date; sleep 30; date; echo Goodbye cruel world; /bin/false"
