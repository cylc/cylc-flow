...
{
morekeywords={NAME,DESCRIPTION,TYPE,CONTACT_DELAY_HOURS,OWNER,VALID_HOURS,EXTERNAL_TASK,EXPORT,RUN_LENGTH_MINUTES,PREREQUISITES,STARTUP_PREREQUISITES,OUTPUTS,RESTART_LIST_MINUTES,COTEMPORAL_DEPENDANTS_ONLY,ONEOFF_FOLLOW_ON},
sensitive=false,
morecomment=[l]{\#},
}
