...
Configures a new system (or reconfigures an existing one after 
...
This is the scheduler program. Multiple server instances can run at once
...
the different systems in the single Pyro nameserver).
