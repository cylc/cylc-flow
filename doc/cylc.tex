...
\definecolor{comments}{rgb}{1.0,0.7,0.0}
...
\begin{lstlisting}
    ...
    CYLC=#INSERT-PATH-TO-TOP-LEVEL-CYLC-INSTALL-DIR#
...
\begin{shaded}
    A task is simply a group of one or more processes that is treated by
    the scheduler as a single entity.
\end{shaded}
