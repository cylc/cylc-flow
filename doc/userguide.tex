...
The suite graph is defined with a concise, intuitive syntax within
freeform multiline strings:

\begin{lstlisting}
# SUITE.RC
[dependencies]
    [[0,6,12,18]]   # hours of validity for the following graph section
        graph = """
            A => B & C   # B and C trigger off A
            C => D       # D triggers off C
                """
    [[6,18]]
        graph = "C => X" # at 6 and 18 hours, X also triggers off C.
\end{lstlisting}
