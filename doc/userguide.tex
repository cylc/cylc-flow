...
(\lstinline=TASKNAME%YYYYMMDDHH=) and \lstinline=$CYLC_SIMULATION_SLEEP=
...
anything to a suite with cylc commands you must register the suite in
...
{\bf This section of the user guide is, unfortunately, yet to be done.}
...
%
%On a coldstart all tasks (including one off tasks) in the sytem will be
...
%        model) tasks without the corresponding one off coldstart tasks to
