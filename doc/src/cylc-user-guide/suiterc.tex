...
A list of the user-defined metadata items of the task.
...
Replace \_\_MANY\_\_ with namespace name and value, and repeat as needed to define all the user-defined metadata items of the task.
Names may contain letters, digits, underscores and hyphens and values may contain letters and digits.
