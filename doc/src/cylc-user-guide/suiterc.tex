...
This section is for {\em External Event Trigger} function declarations -
see~\ref{External Event Triggers}.
...
\item {\em example:} \lstinline@trig_1 = my_trigger(arg1, arg2, kwarg1,
  kwarg2):PT10S@
\end{myitemize}

(See~\ref{External Event Triggers} for details).
...
{\em This feature is deprecated, please use {\em Built-in Clock Triggers}
instead - see~\ref{Built-in Clock Triggers}.}
...
{\em This feature is deprecated, please use {\em External Event Triggers}
instead - see~\ref{External Event Triggers}.}
