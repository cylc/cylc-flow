...
\begin{figure}
    \begin{center}
        \includegraphics[width=6cm]{../../graphics/png/scaled/dep-one-cycle.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=8cm]{../../graphics/png/scaled/timeline-one.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=10cm]{../../graphics/png/scaled/dep-two-cycles-linked.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=6cm]{../../graphics/png/scaled/timeline-one-c.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=8cm]{../../graphics/png/scaled/timeline-one-a.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=8cm]{../../graphics/png/scaled/dep-multi-cycle.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=6cm]{../../graphics/png/scaled/timeline-two-cycles-optimal.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=12cm]{../../graphics/png/scaled/timeline-three.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=8cm]{../../graphics/png/scaled/timeline-two.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=8cm]{../../graphics/png/scaled/task-pool.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{../../graphics/png/scaled/gcylc-graph-and-dot-views.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{../../graphics/png/scaled/gcylc-text-view.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../../graphics/png/scaled/gscan.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/ecox-1.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../../graphics/png/scaled/cylc-review-screenshot.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[height=0.3\textheight]{../../graphics/png/scaled/tut-hello-multi-1.png}
        \hspace{20mm}
        \includegraphics[height=0.3\textheight]{../../graphics/png/scaled/tut-hello-multi-2.png}
        \hspace{20mm}
        \includegraphics[height=0.3\textheight]{../../graphics/png/scaled/tut-hello-multi-3.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        ...
        \includegraphics[width=0.5\textwidth]{../../graphics/png/scaled/tut-one.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../../graphics/png/scaled/tut-two.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../../graphics/png/scaled/tut-three.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.65\textwidth]{../../graphics/png/scaled/tut-cyc-int.png}
    \end{center}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/dep-eg-1.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.25\textwidth]{../../graphics/png/scaled/test1.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/test2.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/test4.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[h]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/test5.png}
    \end{center}
\end{minipage}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.4\textwidth]{../../graphics/png/scaled/satellite.png}
    \end{center}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../../graphics/png/scaled/conditional-triggers.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../../graphics/png/scaled/suicide.png}
    \end{center}
\end{minipage}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.6\textwidth]{../../graphics/png/scaled/ghost-node-example.png}
    \end{center}
...
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/inherit-2.png}
    \end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/inherit-3.png}
    \end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/inherit-4.png}
    \end{center}
\end{minipage}

\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/inherit-5.png}
    \end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/inherit-6.png}
    \end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{../../graphics/png/scaled/inherit-7.png}
    \end{center}
\end{minipage}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=10cm]{../../graphics/png/scaled/params1.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=16cm]{../../graphics/png/scaled/eg2-static.png}
    \end{center}
    \begin{center}
        \includegraphics[width=10cm]{../../graphics/png/scaled/eg2-dynamic.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=10cm]{../../graphics/png/scaled/jinja2-ensemble-graph.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=16cm]{../../graphics/png/scaled/jinja2-suite-graph.png}
    \end{center}
