...
\lstset{language=transcript}
\begin{lstlisting}
$CYLC_DIR/etc/syntax/cylc.vim     # vim
$CYLC_DIR/etc/syntax/cylc-mode.el # emacs
$CYLC_DIR/etc/syntax/cylc.lang    # gedit (and other gtksourceview programs)
$CYLC_DIR/etc/syntax/cylc.xml     # kate
\end{lstlisting}
...
\lstinline=$CYLC_DIR/etc/examples/satellite/= is a
...
The example suite \lstinline=$CYLC_DIR/etc/examples/message-triggers= illustrates
message triggering.
...
\lstinline=$CYLC_DIR/etc/examples/satellite/ext-triggers/suite.rc= is a working
...
\lstinline=$CYLC_DIR/etc/examples/jinja2/dict=:
...
Here's an example, from \\*
\lstinline=$CYLC_DIR/etc/examples/jinja2/defaults=:
