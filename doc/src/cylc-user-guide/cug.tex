...
Tasks loaded in the `submitted' or `running' states are automatically polled 
...
it wipes out prior history, and it could re-run a significant number of tasks
...
{\em Note this disucssion ignores any files - model data etc. - that may be
required by task jobs at run time once the suite has been restarted.}
