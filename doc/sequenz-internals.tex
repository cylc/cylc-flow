...
sequencing logic or prescribed dependencies means that new tasks can be
added and existing ones deleted or switched off without any change to
the algorithm, and partial parallel test systems that feed off the main
operation can be created quickly. Our metascheduling controller, {\em
