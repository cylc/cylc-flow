...
\section{The Impact of Dependencies}
...
\section{Existing Scheduling Systems}
...
This section provides a minimal description of Cylon's novel scheduling
algorithm, which achieves the optimal cycle-independent scheduling of
Figures~\ref{fig-time-one} and~\ref{fig-time-two}; see the abstract for
a summary of major consequences, Section~\ref{sec:implementation} for
implementation detail, and Section~\ref{sec:usage} for system usage.  
