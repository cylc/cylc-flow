...
\title{A Next-General Control System For Cycling Multi-Model Forecasting Operations}
...
\begin{abstract}
    ...
    A control system for a forecasting operation is a form of {\em
    metascheduler} - it determines when members of a set of tasks with
    dependencies are ready to be scheduled for execution.\footnote{The
