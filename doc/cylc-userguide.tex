...
cylc is a metascheduling controller for systems of interdependent
...
completion), you can have cylc trigger downstream tasks off internal
outputs with minor modification of external tasks to get completion of
internal outputs reported back to cylc. 

Section \ref{config} below describes how to configure cylc in order to
control a new system.  Section \ref{usage} describes how to run cylc
once cylc has been configured.
