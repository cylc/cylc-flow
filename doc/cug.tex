...
inlined state - the inlined file will be split back into its constituent
...
With cylc's native file inclusion mechanism you get optional inlined
editing: 
\begin{lstlisting}
% cylc edit --inline SUITE
\end{lstlisting}
The suite will be split back into its constituent include-files when you
exit the edit session. See \lstinline=cylc prep edit --help= for more
information.
