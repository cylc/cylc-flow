...
\begin{figure}
    ...
    \end{center}
\caption[gcylc suite database view]{\scriptsize
gcylc suite database view, showing one suite running on port 7766.}
\label{fig-db}
\end{figure} 
...
\begin{figure}
    ...
    \end{center}
\caption[The gcylc suite control app, dot and text views]{\scriptsize The gcylc suite control app showing dot and text views.}
\label{fig-control1}
\end{figure} 
...
\begin{figure}
    ...
    \end{center}
\caption[The gcylc suite control app, graph and text views]{\scriptsize The gcylc suite control app showing dot and text views.}
\label{fig-control2}
\end{figure} 
...
\begin{myitemize}
    \item {\bf PyGTK}, a Python wrapper for the GTK+ GUI toolkit,
        required for the gcylc GUI (but you can prepare and control
...
The graph view in the suite control GUI has the advantage that it shows
