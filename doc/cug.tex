...
\begin{myitemize}
    ...
    \item {\bf Cylc}, current version THIS IS NOT A VERSIONED RELEASE. 
...
installation; in future we will separate the two to make it easier 
to use multiple versions of cylc concurrently.}
