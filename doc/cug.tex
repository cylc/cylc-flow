...
\paragraph{Pyro 3.9 and Earlier}
...
\begin{myitemize}
    ...
    \item Centralized alerting and timeouts: see documentation of {\em
        task event hooks} in the {\em Suite.rc Reference},
