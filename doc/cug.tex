...
See Section~\ref{passphrases} for more on how cylc's
...
\begin{myitemize}
    ...
    \item It has been suggested that network {\em port forwarding} may 
        provide a solution.
    \item A one-way polling mechanism to track the progress of remote
        tasks that are unable to communicate back to their suite has
        been implemented and is currently in testing and code review.
\end{myitemize}
