...
operation as required.
    ...
    \subsection{Factor Out Common Configuration}
        ...
        which tasks). Cylc has several ways of addressing this problem:
...
\end{lstlisting}
    ...
    such as common job submission method or host. This often coincides
...
\end{lstlisting}
    ...
    outside of the suite definition, so they can be entirely free-form
    for maximum clarity.
\lstset{language=suiterc}
\begin{lstlisting}
[scheduling]
