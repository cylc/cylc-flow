...
\begin{figure}
    \begin{center}
        \includegraphics[width=6cm]{graphics/png/dep-one-cycle.png} 
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=8cm]{graphics/png/timeline-one.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=10cm]{graphics/png/dep-two-cycles-linked.png} 
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=6cm]{graphics/png/timeline-one-c.png} 
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=8cm]{graphics/png/timeline-one-a.png} 
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=8cm]{graphics/png/dep-multi-cycle.png} 
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=6cm]{graphics/png/timeline-two-cycles-optimal.png} 
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=12cm]{graphics/png/timeline-three.png} 
    \end{center}
...
\begin{figure}
    \begin{center} 
        \includegraphics[width=8cm]{graphics/png/timeline-two.png}
    \end{center} 
...
\begin{figure}
    \begin{center} 
        \includegraphics[width=8cm]{graphics/png/task-pool.png}
    \end{center} 
...
\begin{figure}
    \begin{center}
        \includegraphics[width=1.0\textwidth]{graphics/png/dbviewer.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[height=0.35\textheight]{graphics/png/suiterc-jinja2.png}]
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{graphics/png/control1.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{graphics/png/control2.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/ecox-1.png}
    \end{center}
...
for suite graphing and the gcontrol graph view.  For example
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{graphics/png/QuickStartA-graph18.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{graphics/png/QuickStartA-ControlStart06.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{graphics/png/QuickStartA-ControlStart00.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{graphics/png/QuickStartA-ControlRunning.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{graphics/png/QuickStartA-ControlStalled.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.4\textwidth]{graphics/png/QuickStartA-ModelState.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{graphics/png/QuickStartB-graph18.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{graphics/png/suite-output.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{graphics/png/suite-log.png}
    \end{center}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/dep-eg-1.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.25\textwidth]{graphics/png/test1.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/test2.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/test4.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/test5.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.45\textwidth]{graphics/png/test6.png}
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{graphics/png/conditional-triggers.png} 
    \end{center}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{graphics/png/suicide.png} 
    \end{center}
\end{minipage}
...
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/inherit-2.png}
    \end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/inherit-3.png}
    \end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/inherit-4.png}
    \end{center}
\end{minipage}

\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/inherit-5.png}
    \end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/inherit-6.png}
    \end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
    \begin{center}
        \includegraphics[width=\textwidth]{graphics/png/inherit-7.png}
    \end{center}
\end{minipage}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=10cm]{graphics/png/jinja2-ensemble-graph.png} 
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=16cm]{graphics/png/jinja2-suite-graph.png} 
    \end{center}
...
\begin{myitemize}
    ...
    \item {\bf presub} - a task that is ready to run is briefly set to
        this state in the background job submission thread, and then to
        {\em submitted} as soon as its job submission process returns.
        This normally happens too quickly to be seen.
...
And a pseudo-state displayed by the gcontrol graph view:
...
\begin{myitemize}
    \item {\bf ready} - to set a task to {\em ready} is to to set it to
        {\em waiting} and to set all of its prerequisites satisfied.
\end{myitemize}
...
the suite control GUI, and running tasks (cylc clients) can communicate
...
overridden in suite definitions:
\begin{lstlisting}
# SUITE.RC
[cylc]
    maximum number of simultaneous job submissions = 50
\end{lstlisting}
A 120 task ensemble, for example, would be submitted in two batches of
50 followed by one of 20 (note that cylc waits on the {\em job
submission process} to return, not the submitted job itself).
It may take a second or two to complete the job submission process for a
single remote task. 
...
cannot hang indefinitely (this can be caused by suspending a suite with
Ctrl-Z) and prevent a task from completing. But any such timeout must
be sufficiently long to cover the interval required for job submission
and scheduling (above) before cylc gets back to request handling 
{\em just until we plan to have continuous request handling and job
submission in background worker threads}.  The same can be done on the
command line for suite-connecting user commands, with the
\lstinline=--pyro-timeout= option.
