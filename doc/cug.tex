...
conditional triggers, but any valid conditional expression can be used,
as shown in Figure~\ref{fig-conditional} 
...
\begin{myitemize}
    \item {\em family succeeded} means {\em all members
        succeeded}
    \item {\em family failed} means {\em all members finished 
        but one or more of them failed}
\end{myitemize}
For example, this:
\begin{lstlisting}
# SUITE.RC
...
in terms of member dependencies) does not fit your requirements you will
