...
Note also that {\em if you are the cylc admin user} the example suites 
will already be registered in your private database - that's
where they were registered in the first place, in order to be exported
...
section and item. For example, comparing the example suites 
