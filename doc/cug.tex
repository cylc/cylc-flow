...
The suite above is a very simple example of a cycling workflow. More generally,
cylc comprehensively supports the ISO 8601 standard for date-time instants,
intervals, and sequences.  Cycling graph sections can be specified using full
ISO 8601 recurrence expressions, but these may be simplified using context 
information from the suite. One form of the recurrence syntax looks like
...
\lstinline=[[[R/initial-cycle-point/P12H/]]]= - i.e.\ repeat indefinitely every
12 hours starting at the initial cycle point.
