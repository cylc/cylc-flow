...
You can download and install Jinja2 manually from the project web site 
(above), or just use the \lstinline=easy_install= command which will 
do it all in one step. Here's how to easy\_install Jinja2 into your new
private python site packages directory:
...
The Python search path must be set first or \lstinline=easy_install=
will abort. 
...
=> Re-issuing command from /home/oliverh/cylc-4.2.1
--------------------------------------------------------
