    ...
    \item two finished states:
        \begin{myitemize}
            \item {\bf succeeded} - a {\em succeeded } task has finished
                ...
                suite.
            \item {\bf failed}- a {\em failed} task has finished but
                reported failure. Failed tasks are not automatically
...
delayed/catch-up/historical operation when suites are not constrained by
