...
\begin{lstlisting}
shell$ gcylc & # or:
shell$ cylc gui & # Single suite control GUI.
shell$ cylc gscan & # Multi-suite monitor GUI.
\end{lstlisting}
...
\lstset{language=transcript}
\begin{lstlisting}
shell$ cylc import-examples /tmp
\end{lstlisting}
...
\begin{lstlisting}
shell$ mv ~/cylc-run/$(cylc --version)/examples/tutorial ~/cylc-run/tut
shell$ cylc print -ya tut
...
._____._. ._| |_____.           Copyright (C) 2008-2016 NIWA          
