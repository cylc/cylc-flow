...
Run the following command immediately after installation to create your
suite database and import the example suites to it (this involves
copying the suite definitions to sub-directories of the given
destination directory, and registering each one for use in your suite
database:
...
by running the \lstinline=cylc admin import-examples= command: 
