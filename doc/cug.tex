...
virtue of the runahead limit, why the suite has stalled, is
...
\begin{myitemize}
    ...
    \item {\bf Any other sub-directories and files} - documentation,
        ...
        \begin{myitemize}
            ...
            \item Access via \lstinline=$CYLC_SUITE_DEF_PATH= at run time
...
\begin{myitemize}
    ...
    \item {\bf [runtime] } - how, where, and what to execute when a task is ready to run.
        \begin{myitemize}
            ...
            \item a {\em namespace inheritance hierarchy} groups common properties.
...
\end{lstlisting}
Now the graph says that Foo[T] can trigger off {\em either} Bar[T-6] {\em or} 
