...
The passphrase is expected to be in one of the following locations, in
order of preference:
\begin{myitemize}
...
\end{myitemize}
where the suite hostname should be the fully qualified domain name.
The latter locations are convenient for remote suite control in which
case the suite definition directory may not be known or accessible.
