...
%\begin{lstlisting}
%# a line comment
%an unquoted string item = a string value # a trailing comment
%a quoted string item = 'a string value'
%another quoted string item = "a string value"
%a multiline string item = """the quick brown fox
%jumped over the lazy dog"""
%another multiline string item = '''the quick brown fox
%yet another string item = "once upon \
%a time"
%jumped over the lazy dog'''
%a boolean item = True # or False
%a list item = foo, bar, baz 
%another list item = a, b, c, \
%                    d, e, f
%[section]
%    item = value
