...
Suite registration creates the suite run directory under
(\lstinline=~/cylc-run/= by default) and populates it with authentication files
and a symbolic link to a suite definition directory.  Cylc commands that parse
suite definitions can take the file path or the suite name as input. Commands
that interact with running suites have to target the suite by name.
...
\lstset{language=transcript}
\begin{lstlisting}
shell$ cylc print examples.tutorial -y
...
# ...
\end{lstlisting}
See \lstinline=cylc print --help= for other display options. The
...
\lstset{language=transcript}
\begin{lstlisting}
shell$ cylc print --tree -x examples.tutorial
examples
 `-tutorial
   `-cycling
   | | ...
...
\
Rename the tutorial suites to make their names a bit shorter:
\begin{lstlisting}
shell$ mv ~/cylc-run/examples/tutorial ~/cylc-run/tut
shell$ cylc print -x tut
...
E.g.:
\begin{lstlisting}
shell$ cylc print -t nwp
nwp
 |-oper
 | |-region1  Local Model Region1       /home/hilary/cylc-run/nwp/oper/region1
 | `-region2  Local Model Region2       /home/hilary/cylc-run/nwp/oper/region2
 `-test
   `-region1  Local Model TEST Region1  /home/hilary/cylc-run/nwp/test/region1
\end{lstlisting}
...
\lstset{language=transcript}
\begin{lstlisting}
shell$ cylc register test $HOME/test
