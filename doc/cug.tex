...
\begin{myitemize}
    ...
    \item {\bf A \lstinline=bin/= sub-directory}.
        \begin{myitemize}
            ...
            \item {\em Optional} - tasks can call external
    ...
    \item {\bf A \lstinline=python/= sub-directory}.
        \begin{myitemize}
            \item For user-defined job-submission methods (see
                Section~\ref{TaskJobSubmission}).
            \item {\em Optional} - new job submission methods, if
                needed, can be installed into the cylc source tree, or
                in any directory added to \lstinline=PYTHONPATH= in 
                your environment.
        \end{myitemize}
