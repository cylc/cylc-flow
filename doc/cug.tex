...
[environment]
    ...
    WORKSPACE = /$TMPDIR/$CYLC_SUITE_REGPATH
...
\begin{lstlisting}
$CYLC_SUITE_REGNAME    # foo.bar.baz (for example)
$CYLC_SUITE_REGPATH    # foo/bar/baz
$TASK_NAME             # X
...
export CYLC_SUITE_DIR="/home/oliverh/cylc/examples/CUG_7.4"
export CYLC_SUITE_REGNAME="examples:CUG_74"
export CYLC_SUITE_REGPATH="examples/CUG_74"
...
\begin{lstlisting}
# SUITE.RC
job submission log directory = $HOME/CylcJobLogs/$CYLC_SUITE_REGPATH
\end{lstlisting}
...
specific, e.g.
\begin{lstlisting}
$HOME/output/$CYLC_SUITE_REGPATH
\end{lstlisting}
