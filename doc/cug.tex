...
{\em examples:CUG_73} (unfortunately the suite was registered under 
...
\begin{figure}
    ...
    \end{center}
    \caption[Suite {\em examples:CUG_73} Validation.]{\small Suite
    {examples:CUG_73} Validation.}
...
examples:CUG_74} in the central suite database):
