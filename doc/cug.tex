...
************************************************************************
SUBMIT No.1(1,1): ( perl -e "setpgrp(0,0);exec(@ARGV)"
$HOME/cylc-run/tut.oneoff.basic/log/job/hello.1.1 </dev/null
  1>$HOME/cylc-run/tut.oneoff.basic/log/job/hello.1.1.out
  2>$HOME/cylc-run/tut.oneoff.basic/log/job/hello.1.1.err & echo $!; wait )
Stopping: 
...
*          `cylc license conditions'; `cylc license warranty'          *
************************************************************************
SUBMIT No.1(1,1): (echo "perl -e \"setpgrp(0,0);exec(@ARGV)\"
 $HOME/cylc-run/tut.oneoff.basic/log/job/hello.1.1
  1>$HOME/cylc-run/tut.oneoff.basic/log/job/hello.1.1.out
  2>$HOME/cylc-run/tut.oneoff.basic/log/job/hello.1.1.err" | at now)
Stopping: all cycling tasks have spawned past the final cycle 1
...
task, which uses \lstinline=$CYLC_TASK_CYCLE_POINT=. The registered
