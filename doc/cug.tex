...
immediately below [runtime] are, for want of a better term, {\em
namespaces}\footnote{We use the term namespace in loose analogy with its
...
define runtime properties for individual tasks or for families of tasks.
