...
\begin{myitemize}
    ...
    \item {\bf sqlite (a self-contained, serverless, zero-configuration,
        transactional SQL database engine}. This is likely included in
        your Linux distribution already. Cylc generates an sqlite
        database for each suite as it runs, to record task events and
        status.
