...
(above) but the easiest way to do it is the \lstinline=easy_install=
command, which downloads and installs Jinja2 in one step. Here's how to
install Jinja2 into your new private python site packages directory:
...
The Python search path must be set first because
\lstinline=easy_install= aborts if your chosen installation directory
isn't in it. 
