...
\end{lstlisting}
        ...
        future enhancement) it would be a technical error too. Note, however,
        that cylc now automatically strips indentation, as determined by
        the first non-blank line, which defuses this argument somewhat.
