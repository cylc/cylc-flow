...
"retrieve job log=True" under the "[[[remote]]]" section:
...
very little resource to run and should return instantaneously. (Each event
...
The value of each setting should be a list of shell scripts or shell script
templates (see below).
...
settings, where the former is a list of shell scripts or shell script templates
...
Note: The handler commands is equivalent to
