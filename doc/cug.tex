...
alone as can be seen from many of the examples that illustrate this
User Guide (command scripting, for example, defaults to printing a
simple message, sleeping for between 1 and 15 seconds, and then
exiting). These default values are documented with each configuration
item in Appendix~\ref{SuiteRCReference}, and Section~\ref{SuiteDefaults}
shows them all in context.  You can override them or provide your own
defaults for other items by explicitly configuring the root namespace. 
