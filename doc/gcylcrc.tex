...
Set the suite view panels initial orientation, when the GUI starts. This can be changed later using the View - Toggle views side-by-side option using the tool bar.
