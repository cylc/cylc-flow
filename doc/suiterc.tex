...
Cylc usually uses a $CCYYMMDDThhmmZ$ ($Z$ in the special case of UTC) or
$CCYYMMDDThhmm±hhmm$ format for writing down date/time cycle points, which
...
supported tokens are $\%F$, $\%H$, $\%M$, $\%S$, $\%Y$, $\%d$, $\%j$, $\%m$,
$\%s$, $\%z$.
