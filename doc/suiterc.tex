...
\paragraph[dummy command scripting]{[runtime] $\rightarrow$ [[\_\_NAME\_\_]] $\rightarrow$ dummy command scripting}

The scripting to execute when the associated task is ready to run, {\em in dummy mode} - this
can be a single command or a multiline string of scripting. 
...
mode to generate runtime graphs very quickly.
