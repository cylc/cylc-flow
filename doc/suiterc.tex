...
\paragraph[abort if shutdown handler fails]{[cylc] $\rightarrow$ [[event hooks]] $\rightarrow$ abort if shutdown handler fails}

Cylc does not normally care whether a shutdown event handler, executed just
