...
Location of the bash command used to interpret the job script submitted by the
suite daemon when a task is ready to run.
{\em It has no bearing on any sub-shells that may be called by the job script.}
You only have to set this if bash is not in a standard location in your system.
