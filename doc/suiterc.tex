...
running tasks} so if you wish to pass in additional information to hook 
scripts via the environment use [cylc] $\rightarrow$ [[environment]],
...
submitted, the hook script will be called by cylc with
...
started running, the hook script will be called by cylc with {\em
