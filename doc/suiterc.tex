...
e.g.\ event hook scripts and task job submission commands. {\em Note that
these variables are only available to executing tasks if you happen to
choose a local direct job submission method - use task runtime
