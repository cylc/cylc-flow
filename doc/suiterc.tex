...
The reference above gives default values where applicable. The spec file
itself can also be consulted, but note that several defaults come in via
the cylc configuration source module \lstinline=lib/cylc/config.py=
after the suite.rc file is parsed and validated against the spec.
