...
If True, the gcylc graph-view will write a dot-language graph file to the suite
share directory on every change. These can be post-processed into a movie
showing how the suite evolves, by \lstinline=$CYLC_DIR/dev/bin/live-graph-movie.sh=. 
