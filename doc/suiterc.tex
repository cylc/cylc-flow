...
\item {\em legal values:} 
   \begin{myitemize}
       ...
       \item {\em at\_now} - the rudimentary Unix \lstinline=at= scheduler
...
directives are written to the top of the task job script in
the format required by loadleveler; and similarly for PBS, and so on.
