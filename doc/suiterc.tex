...
This appendix defines all cylc suite.rc config items.

{\em Note that Jinja2 expressions can also be embedded in suite
definitions to programmatically generate the final result parsed by
cylc.} Use of Jinja2 is documented in Section~\ref{Jinja2}.
