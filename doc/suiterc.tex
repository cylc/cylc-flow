...
\paragraph[EVENT handler]{[cylc] \textrightarrow [[event hooks]] \textrightarrow EVENT handler}
...
\paragraph[handlers]{[cylc] \textrightarrow [[[event hooks]]] \textrightarrow handlers}
...
\paragraph[handler events]{[cylc] \textrightarrow [[event hooks]] \textrightarrow handler events}
...
\paragraph[mail events]{[cylc] \textrightarrow [[event hooks]] \textrightarrow mail events}
...
\paragraph[mail from]{[cylc] \textrightarrow [[event hooks]] \textrightarrow mail from}
...
\paragraph[mail smtp]{[cylc] \textrightarrow [[event hooks]] \textrightarrow mail smtp}
...
\paragraph[mail to]{[cylc] \textrightarrow [[event hooks]] \textrightarrow mail to}
...
\paragraph[timeout]{[cylc] \textrightarrow [[event hooks]] \textrightarrow timeout}
...
\paragraph[reset timer]{[cylc] \textrightarrow [[event hooks]] \textrightarrow reset timer}
...
\paragraph[abort if startup handler fails]{[cylc] \textrightarrow [[event hooks]] \textrightarrow abort if EVENT handler fails}
...
\subsubsection{[authentication] \textrightarrow public}
...
\paragraph[retry delays]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow retry delays}
\label{RefRetries}
...
\paragraph[submission polling intervals]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow submission polling intervals}
...
\paragraph[execution polling intervals]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow execution polling intervals}
...
\paragraph[{[[[}job submission{]]]}]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[job submission]]]}

This section configures the means by which cylc submits task job scripts to run.

\subparagraph[method]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[job submission]]] \textrightarrow method}
...
\subparagraph[command template]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[job submission]]] \textrightarrow command template}
...
\subparagraph[shell]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[job submission]]] \textrightarrow shell}
\label{JobSubShell}
...
\subparagraph[retry delays]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[job submission]]] \textrightarrow retry delays}
...
\paragraph[{[[[}event hooks{]]]}]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[event hooks]]]}
...
\subparagraph[EVENT handler]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[event hooks]]] \textrightarrow EVENT handler}
...
\subparagraph[submission timeout]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[event hooks]]] \textrightarrow submission timeout}
...
\subparagraph[execution timeout]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[event hooks]]] \textrightarrow execution timeout}
...
\subparagraph[reset timer]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[event hooks]]] \textrightarrow reset timer}
...
\subparagraph[register job logs retry delays]{[runtime] \textrightarrow [[\_\_NAME\_\_]] \textrightarrow [[[events]]] \textrightarrow register job logs retry delays}
