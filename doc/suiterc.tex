...
By default Cylc will submit remote ssh commands using a login shell, which
sources a user's ~/.profile settings. For security reasons some institutions do
not allow unattended commands to start login shells, setting this item to
false will disable that behaviour.
