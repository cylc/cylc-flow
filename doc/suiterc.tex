...
(e.g. \lstinline@host = $(host-selector.sh)@  or
 \lstinline@host = `host-selector.sh`@); but this has been deprecated in
 favour of the \lstinline=host selection command=  item, just
 below, which also gives access to the site/user config file for host
