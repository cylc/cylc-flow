...
suite's minimum cycling interval.
\begin{myitemize}
    \item {\em type:} ISO 8601 interval string e.g. \lstinline=PT12H=
    for a 12 hour limit.
...
trigger, until their cycle point exceeds the initial cycle point by more
