...
\subsubsection[disable automatic shutdown]{[cylc] $\rightarrow$ disable automatic shutdown}

This has the same effect as the \lstinline{--no-auto-shutdown} option for
