...
\subparagraph[retrieve job log retry delays]{[runtime] $\rightarrow$ [[\_\_NAME\_\_]] $\rightarrow$ [[[remote]]] $\rightarrow$ retrieve job log retry delays}
...
the case, you can configure retry delays for job log retrieval by setting some
retry delays.
...
Specify any retry delays in case an event handler does not return 0 (zero).
...
Specify any retry delays in case the mail notification command fails.
