...
def get_option_parser() -> COP:
    ...
    parser.add_option(
        ...
        help=(
            ...
            ' initial cycle point and later cycles, which can make graph'
            ' layout messy. Instead of drawing arrows from R1 leaf tasks'
            ' (i.e. those R1 tasks that connect to the rest of the graph) to'
            ' every later cycle, this option duplicates them into the later'
            ' cycles, for a cleaner graph layout.'
        ),
        action='store_true',
        default=False,
