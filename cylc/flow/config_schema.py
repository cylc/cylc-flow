...
SPEC = {
    ...
    "cylc": {
        ...
        "health check interval": [VDR.V_INTERVAL, DurationFloat(60)],
        "task event mail interval": [VDR.V_INTERVAL, DurationFloat(60)],
        "disable automatic shutdown": [VDR.V_BOOLEAN],
        "simulation": {"disable suite event handlers": [VDR.V_BOOLEAN, True]},
        "environment": {"__MANY__": [VDR.V_STRING]},
        "parameters": {"__MANY__": [VDR.V_PARAMETER_LIST]},
        "parameter templates": {"__MANY__": [VDR.V_STRING]},
        "events": {
        ...
        "reference test": {"expected task failures": [VDR.V_STRING_LIST]},
        "authentication": {
    ...
    "document viewers": {"html": [VDR.V_STRING, "firefox"]},
    # client
    "editors": {
    ...
    # client
    "monitor": {"sort order": [VDR.V_STRING, "definition", "alphanumeric"]},
    "hosts": {
        "localhost": {
            ...
            "scp command": [
                VDR.V_STRING,
                "scp -oBatchMode=yes -oConnectTimeout=10",
            ],
            "ssh command": [
                VDR.V_STRING,
    ...
    "scheduling": {
        ...
        "xtriggers": {"__MANY__": [VDR.V_XTRIGGER]},
        "graph": {"__MANY__": [VDR.V_STRING]},
    },
    "runtime": {
        "__MANY__": {
            ...
            "environment": {"__MANY__": [VDR.V_STRING]},
            "directives": {"__MANY__": [VDR.V_STRING]},
            "outputs": {"__MANY__": [VDR.V_STRING]},
            "parameter environment templates": {"__MANY__": [VDR.V_STRING]},
        }
    },
    "suite logging": {
        "rolling archive length": [VDR.V_INTEGER, 5],
    ...
    "visualization": {
        ...
        "default node attributes": [
            VDR.V_STRING_LIST,
            ["style=unfilled", "shape=ellipse"],
        ],
        "default edge attributes": [VDR.V_STRING_LIST],
        "node groups": {"__MANY__": [VDR.V_STRING_LIST]},
        "node attributes": {"__MANY__": [VDR.V_STRING_LIST]},
    },
    # suite
...
def upg(cfg, descr):
    ...
    u.obsolete(
        "8.0.0", ["cylc", "reference test", "dummy-local mode suite timeout"]
    )
    u.obsolete(
        "8.0.0", ["cylc", "reference test", "simulation mode suite timeout"]
    )
    u.obsolete("8.0.0", ["cylc", "reference test", "required run mode"])
    u.obsolete(
        "8.0.0", ["cylc", "reference test", "suite shutdown event handler"]
    )
    u.deprecate(
        "8.0.0",
...
class GlobalConfig(ParsecConfig):
    ...
    def get_host_item(
        self, item, host=None, owner=None, replace_home=False, owner_home=None
    ):
