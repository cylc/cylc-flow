...
class WorkflowStopMode(graphene.Enum):
    ...
    Clean = StopMode.REQUEST_CLEAN  # type: graphene.Enum
    Kill = StopMode.REQUEST_KILL  # type: graphene.Enum
    Now = StopMode.REQUEST_NOW  # type: graphene.Enum
    NowNow = StopMode.REQUEST_NOW_NOW  # type: graphene.Enum
