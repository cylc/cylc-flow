...
Convert frame-*.dot files in the workflow share directory (as generated by the
...
WORKFLOW=$1
if ! cylc pr --fail $WORKFLOW >/dev/null; then
    usage
    exit 1
fi
...
# Move to the workflow share directory.
cd "${HOME}/cylc-run/${WORKFLOW}/share"
